...
public class TomoriMC implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        ServerMessageEvents.CHAT_MESSAGE.register((message, sender, params) -> {
            DiscordWebSocket.getInstance().sendChat(sender.getGameProfile().name(), message.signedContent());
        ...
        ServerPlayConnectionEvents.JOIN.register((handler, sender, server) -> {
            String playerName = handler.player.getGameProfile().name();
            String playerUuid = handler.player.getUUID().toString();
            boolean isOp = server.getPlayerList().isOp(new net.minecraft.server.players.NameAndId(handler.player.getGameProfile()));
        ...
        ServerPlayConnectionEvents.DISCONNECT.register((handler, server) -> {
            DiscordWebSocket.getInstance().sendQuit(handler.player.getGameProfile().name());
        });
